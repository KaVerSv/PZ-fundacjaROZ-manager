    ...
    return (
        <InputWrapper labelFor={name} labelNote={label} error={error} alwaysShowLabel={alwaysShowLabels}
                      labelColor={labelColor}>
            {
                type === "textarea" ?
                    <textarea
                        className="appearance-none block h-36 w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        id={name}
